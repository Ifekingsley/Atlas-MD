...
if (!gg) {
  gg = "265889976968";   // You can Change this number //
}

// -------------------------------------------------------------- //


global.owner = gg.split("265889976968,");
...
global.packname = process.env.PACKNAME || `Kingz MD`;
global.author = process.env.AUTHOR || "by: Team Kingsley";
